...
public class euclideanDistance {
    ...
    public static double distance4_normalized (int[] point1,int[] point2) {
        ...
        double x1 = (double) (point1[0] - x_min)/ x_max;
        double y1 = (double) (point1[1] - y_min) / y_max;
        double z1 = (double) (point1[2] - z_min) / z_max;
        double j1 = (double) (point1[3] - j_min)/ j_max;
        double x2 = (double) (point2[0] - x_min) / x_max;
        double y2 = (double) (point2[1] - y_min) / y_max;
        double z2 = (double) (point2[2] - z_min) / z_max;
        double j2 = (double) (point2[3] - j_min) / j_max;
